...
function WebDevTester() {
  ...
  async function getCombined() {
    ...
    const res = await fetch('web-dev-tester/combined.json');
  ...
  return (
    <div className="banner_box banner">
      ...
      <h2 style={{color: 'blue', marginTop: '5px', marginBottom: '-2px'}}>Web Dev Tester</h2>
      <div className="container">
        ...
        <div className='item' style={{backgroundImage: 'none', backgroundColor: '#333333'}}>
          ...
          {question_cluster ? (<h2 style={{whiteSpace: 'pre-line', fontFamily: 'none', textAlign: 'left', marginLeft: '10px'}}><br />{current_question}</h2>) : null}
